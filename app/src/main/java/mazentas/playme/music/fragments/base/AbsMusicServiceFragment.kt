...
open class AbsMusicServiceFragment(@LayoutRes layout: Int) : Fragment(layout),
    ...
    val navOptions by lazy {
        navOptions {
            ...
            anim {
                enter = R.anim.smart_fragment_open_enter
                exit = R.anim.smart_fragment_open_exit
                popEnter = R.anim.smart_fragment_close_enter
                popExit = R.anim.smart_fragment_close_exit
            }
        }
    }
