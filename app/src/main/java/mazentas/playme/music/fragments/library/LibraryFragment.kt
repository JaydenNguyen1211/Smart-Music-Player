 ...
 *
 */
package mazentas.playme.music.fragments.library
...
import mazentas.playme.music.databinding.FragmentLibraryBinding
...
class LibraryFragment : AbsMainActivityFragment(R.layout.fragment_library) {
    ...
    private fun setupTitle() {
        ...
        val appName = "Smart <span  style='color:$hexColor';>Music</span>".parseAsHtml()
