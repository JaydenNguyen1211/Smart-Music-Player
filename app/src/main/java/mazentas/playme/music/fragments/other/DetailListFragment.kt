 ...
 *
 */
package mazentas.playme.music.fragments.other
...
import mazentas.playme.music.adapter.album.AlbumAdapter
import mazentas.playme.music.adapter.artist.ArtistAdapter
import mazentas.playme.music.adapter.song.ShuffleButtonSongAdapter
import mazentas.playme.music.adapter.song.SongAdapter
import mazentas.playme.music.databinding.FragmentPlaylistDetailBinding
import mazentas.playme.music.db.toSong
...
class DetailListFragment : AbsMainActivityFragment(R.layout.fragment_playlist_detail),
    ...
    private fun gridCount(): Int {
        if (SmartUtil.isTablet) {
            return if (SmartUtil.isLandscape) 6 else 4
        }
        return if (SmartUtil.isLandscape) 4 else 2
    }
