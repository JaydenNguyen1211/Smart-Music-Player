 ...
 *
 */
package mazentas.playme.music.fragments.player.material
...
import mazentas.playme.music.databinding.FragmentMaterialBinding
...
import mazentas.playme.music.views.DrawableGradient
...
class MaterialFragment : AbsPlayerFragment(R.layout.fragment_material) {
    ...
    private fun colorize(i: Int) {
        ...
        valueAnimator?.setDuration(ViewUtil.SMART_MUSIC_ANIM_TIME.toLong())?.start()
    }
