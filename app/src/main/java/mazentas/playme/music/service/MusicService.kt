 ...
 */
package mazentas.playme.music.service
...
import mazentas.playme.music.activities.LockScreenActivity
import mazentas.playme.music.appwidgets.AppWidgetBig
import mazentas.playme.music.appwidgets.AppWidgetCard
import mazentas.playme.music.appwidgets.AppWidgetCircle
import mazentas.playme.music.appwidgets.AppWidgetClassic
import mazentas.playme.music.appwidgets.AppWidgetMD3
import mazentas.playme.music.appwidgets.AppWidgetSmall
import mazentas.playme.music.appwidgets.AppWidgetText
import mazentas.playme.music.auto.AutoMediaIDHelper
...
import mazentas.playme.music.model.smartplaylist.AbsSmartPlaylist
import mazentas.playme.music.providers.HistoryStore
import mazentas.playme.music.providers.MusicPlaybackQueueStore
import mazentas.playme.music.providers.SongPlayCountStore
import mazentas.playme.music.service.notification.PlayingNotification
import mazentas.playme.music.service.playback.Playback
import mazentas.playme.music.service.playback.Playback.PlaybackCallbacks
import mazentas.playme.music.util.MusicUtil
import mazentas.playme.music.util.MusicUtil.toggleFavorite
import mazentas.playme.music.util.PackageValidator
import mazentas.playme.music.util.PreferenceUtil.crossFadeDuration
import mazentas.playme.music.util.PreferenceUtil.isAlbumArtOnLockScreen
import mazentas.playme.music.util.PreferenceUtil.isBluetoothSpeaker
import mazentas.playme.music.util.PreferenceUtil.isBlurredAlbumArt
import mazentas.playme.music.util.PreferenceUtil.isHeadsetPlugged
import mazentas.playme.music.util.PreferenceUtil.isLockScreen
import mazentas.playme.music.util.PreferenceUtil.isPauseOnZeroVolume
import mazentas.playme.music.util.PreferenceUtil.playbackPitch
import mazentas.playme.music.util.PreferenceUtil.playbackSpeed
import mazentas.playme.music.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import mazentas.playme.music.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import mazentas.playme.music.volume.AudioVolumeObserver
import mazentas.playme.music.volume.OnAudioVolumeChangedListener
