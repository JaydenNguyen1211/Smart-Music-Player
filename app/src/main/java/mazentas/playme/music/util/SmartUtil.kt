...
object SmartUtil {
    ...
    fun getIpAddress(useIPv4: Boolean): String? {
        try {
                    ...
                    if (!addr.isLoopbackAddress) {
                        ...
                        if (sAddr != null) {
                            ...
                            if (useIPv4) {
                                ...
                                if (isIPv4) {
                                    Log.d("SmartUtil", "Using IP address: $sAddr")
                                    return sAddr
                                }
                            } else {
                                if (!isIPv4) {
                                    ...
                                    Log.d("SmartUtil", "Using IPv6 address: $processedAddr")
            ...
            Log.e("SmartUtil", "No suitable network interface found")
        } catch (e: Exception) {
            Log.e("SmartUtil", "Error getting IP address: ${e.message}")
        }
        return null
    }
}